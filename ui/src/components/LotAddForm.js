...
class LotAddForm extends React.Component {
  ...
  handleChange = name => event => {
    ...
    console.log(new Date(event.target.value).toISOString().substring(0, 16));
    this.setState({
              ...
              >
                <FormControl className={classes.formControl}>
                  <FormControl className={classes.formControl}>
                    ...
                    >
                      <MenuItem value={""} />
                      <MenuItem value={"ef03765c-6b0f-4333-91d7-975441565cfa"}>
                        Auction
                      </MenuItem>
                      <MenuItem value={"17611e07-e2c4-4ff8-9d37-9b55d579e2e0"}>
                        Sell
                      </MenuItem>
                    </Select>
                  </FormControl>
                                  ...
                                  >
                                    {options.map(data => (
                                      <MenuItem key={data.id} value={data.id}>
                                        <Checkbox
                                          checked={
                                            this.state[field].indexOf(data.id) >
                                            -1
                                          }
                                        />
                              ...
                              >
                                ...
                                >
                                  {options.map(data => (
                                    <MenuItem key={data.id} value={data.id}>
                                      <Checkbox
                                        checked={this.state[field] === data.id}
                                      />
                                      <ListItemText primary={data.name} />
                                    </MenuItem>
                                  ))}
